                ...
                <div class="col-md-8 col-lg-6 col-xxl-3 auth-card">
                    <div class="card mb-0">
                        <div class="card-body pt-5">
                            ...
                            <p class="text-center">
                                {{ __('Terima kasih sudah melakukan daftar ulang! Silakan bayar biaya pendaftaran untuk menerima email verifikasi.') }}
                            </p>

                            <div class="mb-3">
                                <form method="POST"
                                    action="{{ route('re-registration.payment', auth()->user()->form->id) }}"
