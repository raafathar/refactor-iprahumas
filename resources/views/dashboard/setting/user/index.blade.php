<x-app-layout>
    ...
    <x-breadcrumb :items="['Pengaturan', 'Manajemen Pengguna']" />
    ...
    <div class="alert bg-primary-subtle fade show" role="alert">
        <div class="d-flex align-items-center">
            ...
            <span>Untuk menambahkan anggota, Anda dapat melakukannya melalui menu
                <a href="{{ route('users.index') }}"
                   class="alert-link text-primary">Data Anggota</a>.
            </span>
        </div>
    </div>
    ...
    @include('dashboard.setting.user.form')
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/js/feature/setting/users.js') }}"></script>
    @endpush
</x-app-layout>
