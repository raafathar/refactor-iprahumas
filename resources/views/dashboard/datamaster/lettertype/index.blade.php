<x-app-layout>
    ...
    <x-breadcrumb :items="['Data Master', 'Kode Jenis Surat']" />
    ...
    @include('dashboard.datamaster.lettertype.form')
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/js/feature/datamaster/lettertype.js') }}"></script>
    @endpush
</x-app-layout>
