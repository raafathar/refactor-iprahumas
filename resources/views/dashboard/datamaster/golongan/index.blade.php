<x-app-layout>
    ...
    <x-breadcrumb :items="['Data Master', 'Pangkat/Golongan']" />
    ...
    @include('dashboard.datamaster.golongan.form')
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/js/feature/datamaster/golongan.js') }}"></script>
    @endpush
</x-app-layout>
