<x-app-layout>
    ...
    <div class="card card-body">
        <form action="{{ route('trainings.update', $training->id) }}" id="training-form" method="POST"
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <input id="p_title" name="p_title" value="{{ old('p_title') ?? $training->p_title }}"
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="p_location" class="form-control" type="text"
                                value="{{ old('p_location') == null ? $training->p_location : old('p_location') }}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <input id="p_start_date" name="p_start_date"
                                value="{{ old('p_start_date') == null ? $training->p_start_date : old('p_start_date') }}"
                    ...
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="p_end_date" class="form-control" type="datetime-local"
                                value="{{ old('p_end_date') == null ? $training->p_end_date : old('p_end_date') }}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group mb-3">
                            ...
                            <select id="p_type_training" name="p_type_training"
                                value="{{ old('p_type_training') == null ? $training->p_type_training : old('p_type_training') }}"
                                type="text" class="form-control">
                                <option selected disabled>-- PILIH VIA PELAKSANAAN --</option>
                                <option value="offline"
                                    {{ $training->p_type_training == 'offline' ? 'selected' : '' }}>
                                    Luring</option>
                                <option value="online" {{ $training->p_type_training == 'online' ? 'selected' : '' }}>
                                    Daring</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="p_forum_scale" class="form-control" type="text">
                                ...
                                <option value="internal"
                                    {{ $training->p_forum_scale == 'internal' ? 'selected' : '' }}>
                                    Internal</option>
                                <option value="eksternal"
                                    {{ $training->p_forum_scale == 'eksternal' ? 'selected' : '' }}>
                                    Eksternal</option>
                            </select>
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input id="p_kuota" name="p_kuota" type="text" class="form-control"
                                    value="{{ old('p_kuota') == null ? $training->p_kuota : old('p_kuota') }}">
                            </div>
