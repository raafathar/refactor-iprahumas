<x-app-layout>
    ...
    <x-breadcrumb :items="['Data Master', 'Kode Klasifikasi Surat']" />
    ...
    @include('dashboard.datamaster.letterclassification.form')
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/js/feature/datamaster/letterclassification.js') }}"></script>
    @endpush
</x-app-layout>
