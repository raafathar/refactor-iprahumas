<x-app-layout>
    ...
    <x-breadcrumb :items="['Data Master', 'Periode Pendaftaran']" />
            ...
            <div class="col-md-4 col-xl-3">
                <form class="position-relative">
                    <input type="text" class="form-control product-search ps-5" id="input-search"
                        placeholder="Cari Periode Pendaftaran..." />
    ...
    @include('dashboard.datamaster.period.form')
    ...
    @push('scripts')
        ...
        <script src="{{ asset('assets/js/feature/datamaster/period.js') }}"></script>
    @endpush
</x-app-layout>
