        ...
        <div class="custom-container d-flex align-items-center justify-content-between">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 gap-xl-7 gap-8 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link fs-4 fw-bold text-dark link-primary" href="{{ route('landingpage') }}">Beranda</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="dropdown-pages"
                            data-url="{{ route('get.pages') }}">
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fs-4 fw-bold text-dark link-primary" href="{{ route('berita') }}">Berita</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fs-4 fw-bold text-dark link-primary"
                            href="{{ route('pelatihan.index') }}">Pelatihan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fs-4 fw-bold text-dark link-primary"
                ...
                <div class="d-flex gap-3 justify-content-center align-items-center">
                    ...
                    <div>
                        <a href="{{ route('register') }}" class="btn btn-light border border-dark py-8 px-9">Daftar</a>
                    </div>
                </div>
            </div>
        </div>
