...
class UpdateLetterClassificationRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:letter_classifications,name,' . $this->letter_classification->id . ',id',
            'kode' => 'required|integer|min:1|unique:letter_classifications,kode,' . $this->letter_classification->id . ',id',
        ];
    }
