...
class UpdateGolonganRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|max:255|unique:golongans,name,' . $this->golongan->id . ',id',
            'sort_order' => 'required|integer|min:1|unique:golongans,sort_order,' . $this->golongan->id . ',id',
        ];
    }
